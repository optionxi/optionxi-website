  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Slides Container - Using Grid to stack slides on top of each other */}
        <div className="grid">
          {/* Slide 1: Core Architecture */}
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 col-start-1 row-start-1 transition-opacity duration-1000 ease-in-out ${activeSlide === 0 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            {/* Left: Diagram */}
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 col-start-1 row-start-1 transition-opacity duration-1000 ease-in-out ${activeSlide === 1 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            {/* Left: Feature Grid */}
         ...
         <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 col-start-1 row-start-1 transition-opacity duration-1000 ease-in-out ${activeSlide === 2 ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            {/* Left: Platform Cards */}
            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8">
              <div className="mb-6">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed">
                OptionXI is designed to work wherever you are. Whether you&pos;re at your desk or on the move, 
                you have full access to all features. And because it&pos;s open source, you can modify it to 
